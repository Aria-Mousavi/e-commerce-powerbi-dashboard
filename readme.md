...
![User Behavior & Funnel](Dashboard-Screenshots/2-user_behavior_funnel.png)

---

### Revenue & Transactions
![Revenue & Transactions](Dashboard-Screenshots/3-revenue_transactions.png)

---

### Marketing & Campaign Performance
![Marketing & Campaign Performance](Dashboard-Screenshots/4-marketing_campaign.png)
...
│   ├── 1-customers.png
│   ├── 2-user_behavior_funnel.png
│   ├── 3-revenue_transactions.png
│   └── 4-marketing_campaign.png
│
├── data/
│   ├── customers.csv
│   ├── transactions.csv
